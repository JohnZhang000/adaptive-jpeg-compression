...
model_type=(resnet50)
fft_lvl=8
#att_method=(FGSM PGD CW Deepfool FGSM_inf PGD_inf CW_inf FGSM_uni PGD_uni CW_uni Deepfool_uni FGSM_inf_uni PGD_inf_uni CW_inf_uni)
...
do 
    ...
    do 
        ...
        do 
            ...
            CUDA_VISIBLE_DEVICES=3 python ../remove_code/shap_cal_adv.py $model $img_num $dir_shap $att_method_now $eps_now   |tee -a $log_name
