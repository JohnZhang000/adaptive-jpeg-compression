...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/media/ubuntu204/F/Dataset/ILSVRC2012-10', type=str,
                        help='dataset path')
...
def main(args):
    print('Zhang :output_dir:{} log_dir:{}'.format(args.output_dir,args.log_dir))
    ...
    transform_train = transforms.Compose([
            ...
            transforms.Normalize(mean=[0.0020, 0.0021, 0.0022], std=[0.0670, 0.0155, 0.0128]),
            ])
...
if __name__ == '__main__':
    ...
    print('Zhang000 :output_dir:{} log_dir:{}'.format(args.output_dir,args.log_dir))
    if args.output_dir:
