...
do 
    ...
    do 
        ...
        do 
            ...
            CUDA_VISIBLE_DEVICES=1 python ../remove_code/shap_cal_adv.py $model $dataset_val $img_num $dir_shap cifar-10 $fft_lvl $att_method_now $eps_now   |tee -a $log_name
