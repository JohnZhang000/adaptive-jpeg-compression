...
def get_args():
    ...
    parser.add_argument('--img_path', default='/media/ubuntu204/F/Dataset/ILSVRC2012-100/val/n01440764/ILSVRC2012_val_00000293.JPEG', type=str, help='input image path')
    parser.add_argument('--save_path', default='./MAE/results/tmp/visual', type=str, help='save image path')
    parser.add_argument('--model_path', default='./MAE/results/pretrained/pretrain_mae_vit_base_mask_0.75_400e.pth', type=str, help='checkpoint path of model')
