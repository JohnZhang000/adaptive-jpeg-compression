...
fft_lvl=8
att_method=(FGSM_L2_IDP PGD_L2_IDP FGSM_L2_UAP PGD_L2_UAP CW_L2_IDP Deepfool_L2_IDP CW_L2_UAP Deepfool_L2_UAP)
img_num=50
eps=(0.5 1.0 10.0 100.0)
...
do 
    ...
    do 
        ...
        do 
            ...
            CUDA_VISIBLE_DEVICES=0 python ../remove_code/shap_cal_adv.py $model $dataset_val $img_num $dir_shap cifar-10 $fft_lvl $att_method_now $eps_now   |tee -a $log_name
